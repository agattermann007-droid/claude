"""Endbewertung Build 6.10: Ertrag mit Abschluss-Ernte fuer alle Module (3 gueltige Tage fehlen, Vorlauf >= 0,3 R),
Sicher unveraendert (6.00). GFT 2022-26: 16 Stoerungen, Startjahre, Streuung je Stoerung; Fremddaten 2006-21: 4 Stoerungen."""
import numpy as np, sys, json, os, pickle, eng6 as E, evl6 as V, r6, x35 as X, prep5 as P
from concurrent.futures import ProcessPoolExecutor
F10 = X.F10
B = dict(r6.C510, **r6.PAY3)
CFG = {
    "6.10 Ertrag": (dict(B, db_on=0, r21_risk=0.5, nz_risk=0.35, cool_n=3, gesamtbudget=0.9, idea_cap=0.9,
                         bank_on=1, bank_last=3, bank_minr=0.3, bank_mods=15), dict(harv=1)),
    "6.10 Sicher": (dict(B, db_on=0, r21_on=0, nz_on=0, gesamtbudget=0.9, idea_cap=0.9), {}),
}
if __name__ == "__main__":
    ...
    json.dump(res, open(f"x37_{target}.json", "w"), indent=1, default=float)
