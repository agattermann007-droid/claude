"""Build 6.10 wie x37, aber gueltiger Tag erst ab 50,50 $ (0,5 % + 0,50 $ Reserve wie der EA, ValidDayReserveUSD)."""
...
if __name__ == "__main__":
    ...
    json.dump(res, open(f"x39_{target}.json", "w"), indent=1, default=float)
