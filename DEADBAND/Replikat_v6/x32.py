"""Endzahlen 6.00 (Waechter 180 Tage PF > 1,2) auf GFT 2022-26 (16 Stoerungen) und Fremddaten 2006-21 (4 Stoerungen)."""
...
json.dump(res, open(f"x32_{target}.json", "w"), indent=1, default=float)
